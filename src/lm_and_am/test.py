...
def speech_test(am_model, lm_model, test_data, num, sess):
    ...
    data += '*[Test Result] Speech Recognition ' + test_data.data_type + ' set 拼音 word accuracy ratio: ' + str(
        (1 - word_error_num / words_num) * 100) + '%'
    data += '*[Test Result] Speech Recognition ' + test_data.data_type + ' set 汉字 word accuracy ratio: ' + str(
