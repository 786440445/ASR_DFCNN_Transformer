...
class AmLmHparams:
    ...
    parser.add_argument('--am_lr', default=0.0007, type=float)
    parser.add_argument('--lm_lr', default=0.00005, type=float)
    parser.add_argument('--dacay_step', default=5000, type=int)
    parser.add_argument('--min_learning_rate', default=1e-6, type=float)
    parser.add_argument('--gpu_nums', default=1, type=int)
    parser.add_argument('--is_training', default=True, type=bool)
    parser.add_argument('--am_batch_size', default=16, type=int)
    parser.add_argument('--lm_batch_size', default=64, type=int)
