...
class CNNCTCModel():
    ...
    def build_model(self):
        ...
        self.h1_1 = self.cnn_cell(32, self.h1, pool=False)
        self.h1 += self.squeeze_excitation_layer(self.h1_1, 32, 1)

        # [B,800,100,32]
        self.h2 = self.cnn_cell(64, self.h1, pool=True)
        self.h2_1 = self.cnn_cell(64, self.h2, pool=False)
        self.h2 += self.squeeze_excitation_layer(self.h2_1, 64, 2)

        # [B,400,50,64]
        self.h3 = self.cnn_cell(128, self.h2, pool=True)
        self.h3_1 = self.cnn_cell(128, self.h3, pool=False)
        self.h3 += self.squeeze_excitation_layer(self.h3_1, 128, 2)

        self.h4 = self.cnn_cell(128, self.h3, pool=False)
        self.h4_1 = self.cnn_cell(128, self.h4, pool=False)
        self.h4 += self.squeeze_excitation_layer(self.h4_1, 128, 2)

        self.h5 = self.cnn_cell(128, self.h4, pool=False)
        self.h5_1 = self.cnn_cell(128, self.h5, pool=False)
        self.h5 += self.squeeze_excitation_layer(self.h5_1, 128, 2)

        # [B,200,25,128]
        self.h6 = self.cnn_cell(256, self.h5)
